...
export const CITY_LAYOUT: CityLayoutConfig = {
  ...
  hotspots: [
    ...
    { buildingType: 'warehouse', x: 24, y: 25, width: 10, height: 12, zIndex: 24 },
    ...
    { buildingType: 'foresters_house', x: 58, y: 36, width: 10, height: 12, zIndex: 24 },
    { buildingType: 'marketplace', x: 47, y: 33, width: 10, height: 12, zIndex: 24 },
    { buildingType: 'marble_mason', x: 52, y: 28, width: 10, height: 12, zIndex: 25 },
    { buildingType: 'vineyard_estate', x: 52, y: 28, width: 10, height: 12, zIndex: 25 },
    { buildingType: 'crystal_lensworks', x: 52, y: 28, width: 10, height: 12, zIndex: 25 },
    { buildingType: 'sulfur_refinery', x: 52, y: 28, width: 10, height: 12, zIndex: 25 },
    { buildingType: 'trading_post', x: 61, y: 25, width: 10, height: 12, zIndex: 24 },
    ...
    { buildingType: 'workshop', x: 35, y: 28, width: 10, height: 12, zIndex: 25 },
    { buildingType: 'palace', x: 41, y: 24, width: 10, height: 12, zIndex: 26 },
    { buildingType: 'governor_residency', x: 41, y: 24, width: 10, height: 12, zIndex: 26 },
    { buildingType: 'wall', x: 26, y: 8.5, width: 18, height: 13, zIndex: 17, rotationDeg: -25 },
    { buildingType: 'spy_agency', x: 67, y: 36, width: 10, height: 12, zIndex: 24 },
  ],
  emptySlots: [
    { id: 'site-6', x: 31, y: 16, width: 8, height: 9, zIndex: 16 },
    { id: 'site-10', x: 52, y: 28, width: 8, height: 9, zIndex: 16 },
    { id: 'site-12', x: 56, y: 36, width: 8, height: 9, zIndex: 16 },
    { id: 'site-15', x: 47, y: 33, width: 8, height: 9, zIndex: 16 },
  ],
  districts: [
    { id: 'civic', label: 'Civic Core', x: 48, y: 14 },
    { id: 'harbor', label: 'Harbor Road', x: 27, y: 62 },
    { id: 'trade', label: 'Trade Quarter', x: 58, y: 31 },
